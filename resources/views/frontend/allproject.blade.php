                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                ...
                                <div class="info">
                                    <h4>
                                        <a href="{{route('allwebsite')}}">WEB DEVELOPMENT (Dynamic)</a>
                                    </h4>
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('allwebsite')}}">
                                        <img src="/uploads/website/gr3.png" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>
                                        <a href="{{route('allwebsite')}}">RESPONSIVE DESIGN</a>
                                    </h4>
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('allwebsite')}}">
                                        <img src="/uploads/website/gr4.png" alt="Thumb">    
                                    </a>
                                </div>
                                <div class="info">
                                    <h4>
                            ...
                            <nav aria-label="navigation">
                                <ul class="pagination">
                                    <nav role="navigation" aria-label="Pagination Navigation"
                                        ...
                                        <a href="{{route('allwebsite')}}" rel="next"
                ...
                <div class="blog-items">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('logodesign')}}">
                                        <img src="/uploads/graphics/gr1.png" alt="Thumb">    
                                    </a>
                                </div>
                                <div class="info">
                                    <h4>
                            ...
                            <div class="item">
                                ...
                                <div class="info">
                                    ...
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                                        <a href="{{route('brandingdesign')}}">Read more</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="item">
                                ...
                                <div class="info">
                                    ...
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                                        <a href="{{route('posterdesign')}}">Read more</a>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div id="blog" class="blog-area bg-gray default-padding bottom-less">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="site-heading text-center">
                            <h2>Serach Engine Optimization (SEO)</h2>
                            <p>In publishing and graphic design, lorem ipsum is a filler text commonly used to demonstrate
                                the graphic elements of a document or visual presentation graphic elements of a document or visual presentation. </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('allseo')}}">
                                        <img src="/uploads/seo/seo1.jpeg" alt="Thumb">    
                                    </a>
                                </div>
                                <div class="info">
                                    <h4>
                                        <a href="{{route('allseo')}}">Website SEO</a>
                                    </h4>
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                                        <a href="{{route('allseo')}}">Read more</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('allseo')}}">
                                        <img src="/uploads/seo/seo2.jpeg" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>
                                        <a href="{{route('allseo')}}">Page SEO</a>
                                    </h4>
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="{{route('allseo')}}">
                                        <img src="/uploads/seo/seo3.jpeg" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>
                                        <a href="{{route('allseo')}}">Conent SEO</a>
                                    </h4>
                                    <p style="display: block;overflow:hidden">
                                        BrandingIn marketing, branding is the use of a name, term, design, symbol, or other
                                        feature to ident...
