                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="item">
                        ...
                        <div class="info">
                            ...
                            <div class="meta">
                                <ul>
                                    <li><a href="#"><i class="fas fa-calendar-alt "></i>  01 Jan, 2022</a></li>
                           ...
                           <p>
                            ...
                            <div class="post-pagi-area">
                                <a href="{{route('blog6')}}" class="float-left"><i class="fas fa-arrow-left"></i> Previous Post</a>
                                <a href="{{ route('blog2') }}" class="float-right">Next Post <i
