                        ...
                        <div class="row align-center">
                            <div class="col-lg-6 left-info simple-video">
                                <div class="content" data-animation="animated fadeInUpBig">
                                    ...
                                    <p>Reach the people who matter to you. Start your YouTube video campaign on Google Ads. Be seen where everyone is watching and reach the people who matter the most. Reach the Right Customers. No Budget Minimums. Make A Video Ad. Pick Your Budget.
                                    </p>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h2>Our <span> Video Marketing </span>Services  </h2>
                        <p>Video marketing services refer to the professional services offered by companies or individuals to create, produce, and distribute video content to promote a brand, product, or service.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <p> This involves the creation of video content, such as commercials, explainer videos, product demos, and promotional videos. The video production process includes scripting, filming, editing, and post-production.</p>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h4>Video Editing</h4>
                                <p>Editing allows you to enhance the video with text to communicate right to the audience. Editing is also useful for trimming and merging videos seamlessly to the length you want.Trimming is fundamental to editing. </p>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <p>Video advertising generates leads and converts them into sales because consumers love videos. The majority of consumers, up to 96%, say they watch explainer videos when they need more information.
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <p>This involves tracking and analyzing video performance metrics, such as views, engagement rates, and conversions, to measure the effectiveness of video marketing campaigns for your business</p>
