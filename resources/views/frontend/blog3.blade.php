            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="item">
                        <div class="thumb">
                            <a href="#">
                                <img src="uploads/blog/large/blogs3.jpg" alt="Thumb">
                                <div class="post-type">
                        ...
                        <div class="info">
                            ...
                            <div class="meta">
                                <ul>
                                    <li><a href="#"><i class="fas fa-calendar-alt "></i> 01 Mar, 2022</a></li>
                                    <li><a href="#"><i class="fas fa-flag"></i>Graphics Design</a></li>
                                </ul>
                            </div>
                            <h2
                            ...
                            <div class="post-pagi-area">
                                <a href="{{ route('blog2')}}" class="float-left"><i class="fas fa-arrow-left"></i> Previous Post</a>
                                <a href="{{ route('blog4')}}" class="float-right">Next Post <i
