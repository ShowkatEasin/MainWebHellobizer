                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="item">
                        ...
                        <div class="info">
                            ...
                            <div class="meta">
                                <ul>
                                    <li><a href="#"><i class="fas fa-calendar-alt "></i> 01 Apr, 2022</a></li>
                                    <li><a href="#"><i class="fas fa-flag"></i>Social Media Marketing</a></li>
                                </ul>
                            </div>
                            <h2
                            ...
                            <div class="post-pagi-area">
                                <a href="{{route('blog3')}}" class="float-left"><i class="fas fa-arrow-left"></i> Previous Post</a>
                                <a href="{{ route('blog5') }}" class="float-right">Next Post <i
