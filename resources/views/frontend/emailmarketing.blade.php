                        ...
                        <div class="row align-center">
                            <div class="col-lg-6 left-info simple-video">
                                <div class="content" data-animation="animated fadeInUpBig">
                                    ...
                                    <p>Email marketing is a form of direct marketing that involves sending commercial messages to a group of people via email. The goal of email marketing is to promote a product or service,
                                         build brand awareness, or foster customer loyalty.
                                    </p>
                            ...
                            <div class="col-lg-6 right-info">
                                ...
                                <img src="assets/img/illustration/email.png" alt="Thumb">
                            </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h2>Our <span> Email Marketing </span>Services  </h2>
                        <p>Email marketing is a form of direct marketing that involves sending commercial messages to a group of people via email. The goal of email marketing is to promote a product or service, build brand awareness, or foster customer loyalty.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h4>Building Email List</h4>
                                <p>This involves collecting email addresses of people who have opted-in to receive emails from your business. This can be done through website sign-up forms, in-person events, 
                                    or other lead generation tactics to grow your market.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h4>Creating Email Content</h4>
                                <p>This involves crafting a message that will resonate with your audience. Email content can include promotional offers, company news, blogs
                                     content, or other types of information that your audience.</p>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h4>Designing Email Templates</h4>
                                <p>Email templates give you a way to build your brand right into the template itself – your colors, logo and design aesthetic live within the template. The result is a positive, consistent brand experience .</p>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <p>This involves tracking and analyzing the performance of your email campaigns, including open rates, click-through rates, conversion rates, and other metrics. This data can be used to optimize future email campaigns and improve overall email marketing.</p>
                            </div>
                        </div>
                    </div>
